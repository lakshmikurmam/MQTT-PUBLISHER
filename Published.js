...
const topicFileMappings = [
    ...
    { topic: 'MC/V1/testing', file: '../automateddocker/lakshmi1/MQTT-PUBLISHER/agentsTSsub1.json' },
    { topic: 'testing_new', file: '../automateddocker/lakshmi1/MQTT-PUBLISHER/TS.json' },
